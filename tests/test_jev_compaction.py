...
def test_budget_ordering_drops_lowest_first_oldest_among_equals() -> None:
    ...
    scores = {
        "a:0": jc.Scores(relevance=0.6, decision=0.0, oversized=False, kept=True),
        "b:0": jc.Scores(relevance=0.6, decision=0.0, oversized=False, kept=True),
        "c:0": jc.Scores(relevance=0.6, decision=0.0, oversized=False, kept=True),
        "low:0": jc.Scores(relevance=0.4, decision=0.0, oversized=False, kept=True),
    }
