...
^browsers-repair-a-broken-chain [desc: browsers_fetch_missing_intermediates_so_they_hide_a_misordered_chain, keywords: certificate works in the browser but fails in curl, SSL handshake fails only on some clients, unable to get local issuer certificate, works on my laptop but not in CI, type: project, ocd: 2026-07-21, lmd: 2026-07-21]
...
^chain-must-be-leaf-first [desc: the_pem_bundle_must_run_leaf_then_intermediates_never_root_first, keywords: chain order wrong, root certificate first in bundle, openssl verify fails but cert is valid, type: project, ocd: 2026-07-21, lmd: 2026-07-21]
