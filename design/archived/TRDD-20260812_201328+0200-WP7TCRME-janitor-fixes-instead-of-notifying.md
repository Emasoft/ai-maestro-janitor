...
- 2026-09-05T10:44:00+0200 — AMENDMENT (review finding): §F answers MAY THE JANITOR APPLY the exempt subset (yes, as-is). The card's title question — how LOUDLY it acts when it does — is not answered by §F. The loudness gate (one notice per applied fix, never silent) is kept by DECISION here, on the ground that the silent-disable incident (owner directive 2026-07-31) is the failure mode a silent fix would recreate. Same outcome, corrected basis.
