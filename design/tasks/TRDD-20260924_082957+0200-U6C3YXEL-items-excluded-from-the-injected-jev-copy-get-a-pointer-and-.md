...
Amendment S1 re-read (2026-09-24): non-owner inline eligibility now keys on "Jev kept" (s.kept and not s.oversized), not on the token stage's admitted set. Tool and event items shown inline, before and after, on 4 cached sessions: 4->7, 0->8, 2->10, 3->10. Pointers did not drop: 3->5, 5->6, 4->4, 7->10. The injected copy stays under 8,192 bytes. A negative test landed in 73df900b (landed 09b769b2).
