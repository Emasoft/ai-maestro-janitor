...
updated: 2026-08-14T18:11:42+0200
...
- [ ] The three janitor#254 false positives no longer fire at full severity —
      verified by re-running `scripts/agent_context_bench.py`, not by reasoning.
- [ ] A test proving a marker with UNVERIFIED provenance is NOT trusted (the
...
- [ ] No finding is silently suppressed — every downgraded finding is still emitted
      and countable.
- [ ] True positives still fire: the bench's genuine attack samples are re-run and
